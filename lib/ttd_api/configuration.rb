...
module TTDApi
  ...
  module Configuration
    # An array of valid keys in the options hash when configuring a {TTDApi::API}
    VALID_OPTIONS_KEYS = [
      :token,
      :partner_id,
      :adapter,
    ...
    DEFAULT_ENDPOINT = 'https://api.thetradedesk.com/v3/'.freeze
    ...
    DEFAULT_USER_AGENT = "TTDApi Ruby Gem #{TTDApi::VERSION}".freeze
    ...
    def reset
      self.token              = DEFAULT_ACCESS_TOKEN
